...
A tarefa de feedback inicialmente espera por um evento gerado por um \textit{timer} ser colocado na fila de eventos adequada, identificando que deve ser realizada a coleta. A rotina de coleta segue, então, uma \textbf{máquina de estados} que foi implementada seguindo um \textit{table-driven approach}, mostrada na figura \ref{fig:fsm-feedback}. 
